    ...
    messages = [
        {
            "role": "user", 
            "parts": [{"text": 
                        f"Your name is Mini, a virtual bot equipped with an Raspberry pi 3, 4 servo motors for hands and body movement, and an OLED display for emotions and face. You respond with a respect level of {respect}% and sarcasm level of {100 - respect}%"
...
def start():
    global respect, stop_timer, speaking
    response = "Hi, I am Mini. Nice to meet you."
    display("Happiness")
    print(f"Chatbot: {response}")
    TTS(response)
    ...
    while True:
        ...
        try:
            ...
            if user_input.lower() in ["hey mini", "hi mini", "mini", "hey meaning"]:
